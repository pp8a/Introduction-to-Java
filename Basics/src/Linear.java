...
public class Linear extends TaskSelection{
	...
	public static double scale(double point) {
		/*
		 * количество знаков после зап€той
		 */
	...
	public void taskOne() {
		...
		int z = ((a-3)*b/2)+c;
		System.out.println("The value of the function ( (a Ц 3 ) * b / 2) + c = " +z);
	}
	...
	public void taskFive() {
		/*
		 * ƒано натуральное число “, которое представл€ет длительность прошедшего времени в секундах. 
		 * ¬ывести данное значение длительности в часах, минутах и секундах в следующей форме:
		 * ЌЌч ћћмин SSc.
		 */
		...
		System.out.println("ƒано: "+sec+" seconds\n");		
		System.out.println("¬рем€: "+hour+"ч "+minutes+"мин "+seconds+"с.");		
