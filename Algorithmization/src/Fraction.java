...
public class Fraction {
	...
	static int gcd(int p, int q) {
		/**
		 * Евклидов алгоритм вычисления НОД: НОД двух чисел P и Q остается неизменным, даже если большее число заменяется модулем P и Q.
		 * 
		 * выполняем операцию НОД для P и Q несколько раз, заменяя P на Q и Q по модулю P и Q, пока модуль не станет 0.
		 * 
